...
public class CppCategoriser extends C_Categoriser
{
   ...
   * 
   * @see de.marw.nacre.highlight.categoriser.Category#KEYWORD_STATEMENT
   * @param length
   ...
   * 
   * @see de.marw.nacre.highlight.categoriser.Category#KEYWORD_TYPE
   * @param length
   *        the length of the region that must match.
   * @return <code>true</code> if the subregion is one of the keywords,
   *         otherwise <code>false</code>.
   ...
   * 
   * @see de.marw.nacre.highlight.categoriser.Category#KEYWORD_OPERATOR
   * @param length
   *        the length of the region that must match.
   * @return <code>true</code> if the subregion is one of the keywords,
   *         otherwise <code>false</code>.
   ...
   * literals.
   * 
   * @see de.marw.nacre.highlight.categoriser.Category#PREDEFVAL
   * @param length
   *        the length of the region that must match.
   * @return <code>true</code> if the subregion is one of the keywords,
   *         otherwise <code>false</code>.
