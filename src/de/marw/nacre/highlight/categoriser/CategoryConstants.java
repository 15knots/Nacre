 ...
 *      Token)
 * @author Martin Weber
 * @deprecated wird nicht mehr benötigt, Category ist jetzt eine typesafe enumeration.
 */
...
//
//  /**
//   * Literal string category id. This can be used to mark a string literal (eg,
